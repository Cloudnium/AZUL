      ...
      <div className="mb-4">
        ...
        <div className="flex gap-3 items-start">
          ...
          <div className="pb-4">
            ...
            <p className="text-base font-bold text-gray-900 leading-tight">Piura</p>
            <p className="text-sm text-gray-500 mt-0.5">Av. Bolognesi 817 Piura</p>
          </div>
        </div>
        ...
        <div className="flex gap-3 items-start">
          ...
          <div>
            ...
            {variante === 'pago' ? (
              <>
                <p className="text-sm text-gray-500 mt-0.5">{destinoDireccion}</p>
          ...
          <div className="flex gap-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-bold text-gray-900">{fecha ?? '13/02/2026'}</span>
              </div>
            </div>
            <div>
